...
module "networking" {
  ...
  service_vnet_id                     = var.service_vnet_id
  function_app_subnet_id              = var.function_app_subnet_id
  private_endpoint_subnet_id          = var.private_endpoint_subnet_id
  scanner_subnet_ids                  = var.scanner_subnet_ids
  regional_function_app_subnet_ids    = var.regional_function_app_subnet_ids
  regional_private_storage_subnet_ids = var.regional_private_storage_subnet_ids
  tags                                = local.common_tags
}
